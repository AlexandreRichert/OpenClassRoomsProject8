...
function Portfolio() {
  ...
  return (
    <section id='portfolio' className=' bg-blue-200 flex flex-col justify-center items-center py-10'>
      <h1 className='text-4xl text-[#0a192f] mb-14 font-bold sm:text-6xl'> Mon Portfolio</h1>
      <FilteredButtons filterStatus={filterStatus} setFilterStatus={setFilterStatus} />
      <div className='w-full grid gap-16 place-items-center sm:grid-cols-2 2xl:grid-cols-3'>
